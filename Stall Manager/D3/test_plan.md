...
**Black Box-Test:** 
To test the application's UI and its functionality, we are using Robotium along side JUnit. Bulding test cases with a variety of inputs and parameters for each of the different parts of the applications UI will test it for any breaks. 

**White Box-Test:**
Because the internal code of the app is known, we can implement White Box Testing. Although White Box Testing was not implemented in our testing strategy due to the small nature of the app and the time constraints, for future testing strategy, it would have been included.
### 1.2 Test Selection
...
JUnit and Robotium will be used for UI testing. 
TSLgenerator for Category Partitioning.
Robotium
